...
to setup
  ...
  ;; added to prevent -ve number of infected agents
  if initial-outbreak-size < 0
    [ set initial-outbreak-size 0 ]
  ;; added to prevent more infected agents that allocated agents
  if initial-outbreak-size >  number-of-nodes
    [ set initial-outbreak-size number-of-nodes ]
